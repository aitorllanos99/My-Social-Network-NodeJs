...
public class PO_NavView  extends PO_View{
	...
	//Este metodo es asi porque el boton disconect no muestra ninguna pagina por lo que los dos ultimos pasos de arriba no son necesarios
	// e incluso erroneos
	public static void clickOptionNoPages(WebDriver driver, String textOption, String criterio, String textoDestino) {
		//CLickamos en la opción de registro y esperamos a que se cargue el enlace de Registro.
		List<WebElement> elementos = SeleniumUtils.EsperaCargaPagina(driver, "@href", textOption, getTimeout());
		//Tiene que haber un sólo elemento.
		assertTrue(elementos.size()==1);
